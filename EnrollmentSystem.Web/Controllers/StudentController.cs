...
namespace EnrollmentSystem.Web.Controllers
{
    public class StudentController : Controller
    {
        ...
        public StudentController(EnrollmentSystemDbContext context, ILogger<StudentController> logger)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> SubmitStudent(Student student)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    ModelState.AddModelError("", "An error occurred while submitting data.");
